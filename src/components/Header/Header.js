...
const logo = require('./blue_owl.png');
      ...
      <Navbar fluid={true}  style={ {margin: 0} }>
          <Brand>
            <span>
              ...
              <span>&nbsp;Admin Dashboard - </span>
                <a href="http://getstat.com/" title="Start React" rel="home" target="_blank">getstat.com</a>
          ...
          <ul className="nav navbar-top-links navbar-right">
            ...
            <NavDropdown title={<i className="fa fa-bell fa-fw"></i>} id = 'navDropdown3'>
              <MenuItem eventKey="1" style={ {width: 300} }>
                <div> <i className="fa fa-comment fa-fw"></i> Crawling done successfully <span className="pull-right text-muted small">4 minutes ago</span> </div>
              </MenuItem>
              <MenuItem divider />
              <MenuItem eventKey="2">
                <div> <i className="fa fa-twitter fa-fw"></i> 10% Crawl Failure for Bing <span className="pull-right text-muted small">12 minutes ago</span> </div>
              </MenuItem>
              <MenuItem divider />
              <MenuItem eventKey="3">
                <div> <i className="fa fa-envelope fa-fw"></i> New Bugs Came <span className="pull-right text-muted small">4 minutes ago</span> </div>
              </MenuItem>
              <MenuItem divider />
              <MenuItem eventKey="4">
                <div> <i className="fa fa-tasks fa-fw"></i> New Requests <span className="pull-right text-muted small">4 minutes ago</span> </div>
              </MenuItem>
              <MenuItem divider />
              <MenuItem eventKey="5">
